...
È un campo di una transazione Bitcoin che permette la scrittura di 80 byte [(Bitcoin Wiki)](https://en.bitcoin.it/wiki/Script), cioè di 80 caratteri alfanumerici a piacere, che verranno legati per sempre alla transazione.  
Approfondimento storia a questo [link](https://bitcoin.stackexchange.com/questions/29554/explanation-of-what-an-op-return-transaction-looks-like).
...
### Come scrivo l' `OP_RETURN` in una transazione?
Attualmente uso l'applicazione mobile "imToken", che in fase di invio di una transazione, permette di popolare il campo `OP_RETURN`.